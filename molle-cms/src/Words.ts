...
Vue.prototype.$words = {
  ...
  google: {jp: "Google", en: "Google"},
  storage: {jp: "ストレージ", en: "Storage"},
  molleTop: {jp: "Molle TOP", en: "Molle TOP"},
  property: {jp: "プロパティ", en: "Property"},
  firestore: {jp: "firestore", en: "firestore"},
